...
#修复低级错误
fixed_Rules_error "${Rules_Folder}/Adblock_attach.txt"
#剔除冲突的CSS规则
...
#修复低级错误
fixed_Rules_error "${Rules_Folder}/Adblock_Chinese.txt"
#剔除冲突的CSS规则
...
convert_abbreviations "${Rules_Folder}/Adblock.txt"
#净化去重规则
...
#修复低级错误
fixed_Rules_error "${Rules_Folder}/Adblock.txt"
#剔除冲突的CSS规则
