...
(function() {
    ...
    const isSpamBot = (tweetTextEl, tweetNode) => {
        ...
        const nameSpamSuspect = /(?:同城|附近|寻|蹲|约|无|真实|免费|偿|个|丝丝|小猫|茜茜|萝莉|学姐|乔|欣|萌|成人|限制|破除|破限|AI|上门|速配|服务|满足|线下|联系|野战|安排|哥哥|弟弟|男大|女大|单男|体育生|固[萢跑炮狍]|[萢跑狍]友){2,}/i;
        if (nickName) {
