...
(function() {
    'use strict';
    let cleanupCount = 0, removeSelectors = [], clickSelectors = [], stayRules = new Set(), hideRules = new Set(), userAttemptedScroll = false, scrollRestorationAttempted = false;
...
##+js(dpopup, .btn-age-confirm, stay)
##+js(dpopup, .gg-close)
