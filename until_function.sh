...
local file="${1}"
test ! -f "${file}" && return
local lite_content="$(cat ${file} | grep -Ev '#\@\?#|\$\@\$|#\%#|#\@\%#|#\@\$\?#|#\$\?#|#\$#|#\?#|##\+js\(|#\%#\/\/scriptlet|redirect=|\,replace=|redirect-rule=|\$badfilter|\$document|\$empty|\$generichide|\$important|\$match-case|\$media|\$object|\$object-subrequest|\$popup|\$subdocument|\$~badfilter|\$~document|\$~empty|\$~generichide|\$~important|\$~match-case|\$~media|\$~object|\$~object-subrequest|\$~popup|\$~subdocument|\,badfilter$|\,badfilter\,|\,document$|\,document\,|\,empty$|\,empty\,|\,generichide$|\,generichide\,|\,important$|\,important\,|\,match-case$|\,match-case\,|\,media$|\,media\,|\,object$|\,object-subrequest$|\,object-subrequest\,|\,object\,|\,popup$|\,popup\,|\,subdocument$|\,subdocument\,|\,~badfilter$|\,~badfilter\,|\,~document$|\,~document\,|\,~empty$|\,~empty\,|\,~generichide$|\,~generichide\,|\,~important$|\,~important\,|\,~match-case$|\,~match-case\,|\,~media$|\,~media\,|\,~object$|\,~object-subrequest$|\,~object-subrequest\,|\,~object\,|\,~popup$|\,~popup\,|\,~subdocument$|\,~subdocument\,|\$csp|\,csp=|\,denyallow=|\:matches-path' | sort | uniq)"
echo "${lite_content}" > "${file}"
}
...
- [1.4.9.7](https://aloazny.github.io/Aloazny_Adblock/userscript/1.4.9.7.user.js)
